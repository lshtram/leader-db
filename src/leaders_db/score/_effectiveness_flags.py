"""Flag-detection and rationale helpers for the effectiveness scorer.
...
from ._effectiveness_rubric import _SPARSE_OBSERVED_RATIO_THRESHOLD
...
def _filter_excluded_missing(
    ...
    :func:`leaders_db.score._effectiveness_components.filter_excluded_observations`
...
def detect_flags(
    ...
    *,
    ...
    :func:`score_effectiveness`) is derived from these flags; if
...
def build_rationale(
    *,
    ...
    parts: list[str] = []
    parts.append(
        f"Effectiveness score {score_1_10}/10 on the 1..10 prototype "
    ...
    if ReviewFlag.MISSING_PRIMARY_SOURCE in flags:
        parts.append(
            ...
            "wgi_government_effectiveness, wgi_rule_of_law, "
            "vdem_v2x_accountability, bti_governance_index absent."
        )
