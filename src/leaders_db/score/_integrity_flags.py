"""Flag-detection and rationale helpers for the integrity scorer.
...
from ._integrity_rubric import _SPARSE_OBSERVED_RATIO_THRESHOLD
...
def _filter_excluded_missing(
    ...
    :func:`leaders_db.score._integrity_components.filter_excluded_observations`
...
def detect_flags(
    ...
    *,
    ...
    :func:`score_integrity`) is derived from these flags; if the
...
def build_rationale(
    *,
    ...
    parts: list[str] = []
    parts.append(
        f"Integrity score {score_1_10}/10 on the 1..10 prototype "
    ...
    if ReviewFlag.MISSING_PRIMARY_SOURCE in flags:
        parts.append(
            ...
            "wgi_control_of_corruption, vdem_v2x_corr, cpi_score absent."
        )
