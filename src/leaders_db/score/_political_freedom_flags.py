"""Flag-detection and rationale helpers for the political freedom scorer.

This module is the **internal** flag-detection logic of the
political freedom deterministic scorer. The facade in
:mod:`leaders_db.score.political_freedom` calls
...
from ._political_freedom_rubric import _SPARSE_OBSERVED_RATIO_THRESHOLD
...
def _filter_excluded_missing(
    ...
    :func:`leaders_db.score._political_freedom_components.filter_excluded_observations`
...
def detect_flags(
    ...
    *,
    ...
    :func:`score_political_freedom`) is derived from these
...
def build_rationale(
    *,
    ...
    parts: list[str] = []
    parts.append(
        f"Political freedom score {score_1_10}/10 on the 1..10 prototype "
    ...
    if ReviewFlag.MISSING_PRIMARY_SOURCE in flags:
        parts.append(
            ...
            "vdem_v2x_polyarchy, vdem_v2x_libdem absent."
        )
