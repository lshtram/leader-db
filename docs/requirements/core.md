...
- **REQ-ACC-016**: The isolated conversational evidence experiment shall keep prompts, researcher model configurations, and the complete question catalog outside executable code; make the selected research model responsible for web research, source selection, links, and compact summaries; restrict Luna to no-search transcription; preserve every raw research turn before formatting; and emit separate validated evidence and evidence-to-question mapping files with resumable checkpoints and profiling.
