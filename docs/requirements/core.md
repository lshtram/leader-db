...
- **REQ-LLM-021**: Evidence-quality review shall inspect all selected chapters without scoring them and only the exact lenses selected by the job; a bounded lens pilot shall not expand to unselected sibling lenses. It shall distinguish genuine scarcity from shallow collection and return every material, research-recoverable discovery, fetch, locator, contrary-evidence, or attribution gap to the same researcher. Source counts and workflow exhaustion do not prove adequacy. A chapter passes when its concrete record can fairly present the relevant governing conduct, contrary material, and attribution, or when a credible saturation/access blocker shows that another round is unlikely to improve it. Deduplication, neutral wording, mapping, and serialization remain deterministic cleanup. Review and resumption stop on a pass, a credible blocker, or the configured maximum of three rounds.
