...
| `un_snaama` | ⚠️ | UNSD National Accounts Main Aggregates Database | Local UNdata export dated 2026-06-19; 1970–2024; current-price US-dollar GDP and five expenditure aggregates. Clean adapter, validation, and persistence work. Concept mapping and researcher routing are the next increment, so this is not yet researcher-available. |
