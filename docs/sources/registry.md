...
| `iaea_additional_protocol_status` | ⏸️ | IAEA safeguards agreement / Additional Protocol status lists | **Need / future.** A subset/family of `iaea_safeguards` once the unified adapter lands; do not implement as a separate adapter. |
