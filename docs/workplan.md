...
and BTI, the unified source interface now covers historical economy, current
economy, governance, political regime / repression / corruption / social
well-being, press freedom, political terror, corruption perception, and BTI
transformation / effectiveness evidence. **Active next action:** project-manager
review + reviewer pass for the BTI migration, then choose the next clean source
