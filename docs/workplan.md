...
generic store; it does not run web research or invent evidence. The next
infrastructure gaps are broader question-registry coverage for sections 1-8 /
1B-7B, handler/spec coverage for additional executable questions, and
structured/internet-research strategy dispatch.
