...
- The canonical leader/ruler/score schema lives in [`docs/architecture/database-schema.md`](../architecture/database-schema.md) and `src/leaders_db/db/models.py`. Treat those as the source of truth.
...
- Keep `docs/workplan.md`, `docs/architecture/overview.md`, and `docs/requirements/core.md` synchronized.
