...
Preliminary focus: identify only the three to five principal declared or reliably
revealed governing, power-maintenance, or regime-survival goals; the inherited
position, authority, and main obstacles; the principal
...
reach, durability, influence, and goal-realization discipline. Political power
retention and system control may therefore be assessed when they are evidenced goals
or means of execution; survival or control alone is not effectiveness.
