...
|---:|---|---:|---|---|---|
| 1 | Sweden | 1938 | 8B.2 | Per Albin Hansson | Does the ruler translate that program into concrete priorities, plans, budgets, appointments, timelines, institutions, and enforcement mechanisms? |
...
| 7 | Egypt | 1956 | 8B.1 | Gamal Abdel Nasser | Does the ruler articulate a clear governing ideology, strategic direction, or program that can be evaluated against later action? |
