...
The ruler-quality methodology defines eight chapter guides, one for each of
...
must bring a reader who has not seen the evidence into the subject, answer the
chapter-level question, support the appraisal with explained examples, and reach a
clear conclusion. It starts with the ruler's overall appraisal and score; describes
the strongest favorable and unfavorable findings and why they matter; separates
established facts from allegations, inherited conditions, and uncertain attribution;
and concludes why the balance supports this score instead of a materially higher or
lower one. Unfamiliar cases, programs, institutions, and acronyms are defined on
first mention. A rationale must never open with an unexplained controversy or assume
the reader already knows the dossier.

The active guides are:

- `1b-nuclear-existential-risk.md`
- `2b-international-peace.md`
- `3b-domestic-safety.md`
- `4b-political-freedom.md`
- `5b-economic-wellbeing.md`
- `6b-social-wellbeing.md`
- `7b-integrity.md`
- `8b-effectiveness.md`
