...
Preliminary focus: establish inherited services and life chances, prior trends,
principal social policies and executed resources, changes across groups and regions,
major crises and external support, and the ruler’s attributable contribution.
...
Preliminary focus: identify only three to five principal officially declared governing
goals, the inherited position and obstacles, actions and implementers, observable
progress and failure, and durability. Remaining in power is excluded as a governing
achievement.
