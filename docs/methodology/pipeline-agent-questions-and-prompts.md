...
Active layered lens version: `layered_lenses_v2`
...
| 8B judge | Questions 8B.1-8B.10; declared or reliably revealed program portfolio, including evidenced power-maintenance goals, program basis and type, operationalization, mobilization, implementation, adaptation, goal progress, durability, causal attribution, and explicit moral separation |
...
`question_lens_presentation.json` (`layered_lenses_v2`).
...
Preliminary focus: establish authority and security context, inherited conflicts, a
complete inventory of material overseas force, scale, consequences, and ruler
attribution. Record conduct before judging justification; ruler explanations are claims
and receive no presumption of credibility.
...
Preliminary focus: establish trends in state violence and political imprisonment,
intimidation, intergroup violence, serious private and organized violence, and the
ruler’s response. Record material crime increases with government inaction while
distinguishing incapacity, ineffective action, neglect, tolerance, and collusion.
...
Preliminary focus: establish inherited political freedom and its prior direction,
material changes in specific freedoms, principal laws and incidents, comparative
beginning-and-end assessments, and ruler attribution. Comparative datasets guide
research but do not determine judgment.
...
Preliminary focus: establish the inherited economy and prior trend, comparable
beginning-and-end economic and distributional measures, principal decisions, external
...
Preliminary focus: establish inherited health, education, basic services, protection,
dignity and shelter, prior trends, principal social policies and executed resources,
changes across groups and regions, major crises and external support, and the ruler’s
...
Preliminary focus: identify significant falsehoods, manipulation, concealment,
office-connected interests, uses of public power benefiting associates or favored
groups, political entrenchment, independent findings, and the ruler’s response.
...
Preliminary focus: identify only three to five principal declared or reliably revealed
governing, power-maintenance, or regime-survival goals, the inherited position and
obstacles, actions and implementers, observable progress and failure, and durability.
